...
def train_model():
    try:
        ...
        TARGET_COL = os.getenv("TARGET_COL") or "target"
        ...
        logging.info("Train Classification Report:",classification_report(y_train, y_train_pred))
        logging.info("Test Classification Report:", classification_report(y_test, y_test_pred))
        # save trained model
